...
cargo run --release --features wgpu,auto-tfx -- train --returns weighted --advantages baseline --episodes 256 --mini-batch-size 256 --cache-file checkpoints/data.cache --sequences-file checkpoints/bench-top.bin --checkpoint-dir checkpoints/auto-tfx-weighted-256ep
