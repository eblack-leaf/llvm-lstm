...
Weighted-return parameters are used only when \texttt{--returns weighted}.}
\label{tab:hparams}
\centering
\begin{tabular}{ll}
\toprule
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{auto-tfx-episode-256ep.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{auto-gru-episode-256ep.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{auto-tfx-weighted-256ep.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{auto-gru-weighted-256ep.png}
...
The log-probability objective encourages the beam to favour
high-probability prefixes---the common early passes learned by the
policy (\pass{sroa}, \pass{gvn}, \pass{inline})---rather than the
function-specific combinations that yield the best speedup.
